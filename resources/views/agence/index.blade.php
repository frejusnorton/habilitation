...
@section('page-title')
    <div class="page-title d-flex flex-column me-3">
        ...
        <h1 class="d-flex text-white fw-bolder my-1 fs-3">Listes des agences</h1>
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-white opacity-75">Agences</li>
        </ul>
    </div>
    <!--begin::Actions-->
            ...
            <ul class="dropdown-menu p-4 shadow-lg" style="min-width: 280px;">
                ...
                <li class="d-flex flex-column gap-2">
                    ...
                    <a class="dropdown-item export-option d-flex align-items-center" data-type="excel"
                        href="{{route('export-agence-excel')}}">
