    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        <thead>
            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                ...
                <th class="min-w-125px text-center">Menu</th>
        ...
        <tbody class="text-gray-600 fw-semibold">
            @forelse ($actions as $action)
                <tr>
                    ...
                    <td>
                        <div class="badge badge-light fw-bold">{{ $action->identifiant ? $action->identifiant : '' }}</div>
                    </td>
                    ...
                    <td class="text-center">
                        {{ $action->menu->titre ? $action->menu->titre : '' }}
                    </td>
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                ...
                                data-identifiant="{{ $action->identifiant }}" data-libelle="{{ $action->libelle }}"
                                data-menu="{{ $action->menu_id }}" data-statut="{{ $action->statut }}"
                                data-url="{{ route('app_acl_update', $action->id) }}"
                                data-bs-target="#kt_modal_update_action">
                            ...
                            <div class="menu-item px-3">
                                ...
                                data-url="{{ route('app_acl_delete', $action->id) }}"  data-kt-users-table-filter="delete_row">
