<div class="modal fade" id="kt_modal_add_action" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Ajout d'une action</h2>
                <!--end::Modal title-->
            ...
            <div class="modal-body scroll-y mx-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_update_role_form" class="form" action="{{ route('app_acl_new') }}" method="POST">
                    @csrf
                    <!--begin::Scroll-->
                            ...
                            <div class="col-md-6">
                                <div class="fv-row mb-10">
                                    ...
                                    <input class="form-control form-control-solid"
                                        placeholder="Entrer l'identifiant" name="identifiant"
                                        value=""  type="text"/>
                                    <!--end::Input-->
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <select name="menu" data-control="select2" data-placeholder="Selectionner le menu" data-hide-search="true" class="form-select form-select-solid">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <label class="form-check form-switch form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input" name="statut" type="checkbox" value="1" id="statut" />
                                        </label>
                                        <!--end::Switch-->
                                    </div>
                                    <!--begin::Wrapper-->
