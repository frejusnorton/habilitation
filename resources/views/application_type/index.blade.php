...
@section('page-title')
    <div class="page-title d-flex flex-column me-3">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-white opacity-75">Les types d'applications</li>
        </ul>
    </div>
    <!--begin::Actions-->
    <div class="d-flex align-items-center py-3 py-md-1 gap-5">
        ...
        <a href="#" class="btn btn-primary btn-sm " data-bs-toggle="modal" data-bs-target="#kt_modal_add_menu_type"
...
@section('content')
    <div class="card">
        ...
        <div class="card-body py-4" id="datapart">
            @include('application_type.datatable')
            
        </div>
    </div>
   @include('application_type.edit')
   @include('application_type.create')
@endsection

@section('js')
    @include('application_type.js')
@endsection
