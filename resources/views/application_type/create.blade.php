...
<div class="modal fade" id="kt_modal_add_menu_type" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-450px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bold " id="modalTitle">Type d'application</h2>
            ...
            <div class="modal-body scroll-y mx-5 ">
                <!--begin::Form-->
                <form id="addType" class="form" method="POST" action=" {{ route('application_type.create') }}">
                    @csrf
                    <!--begin::Scroll-->
