...
@section('page-title')
    <div class="page-title d-flex flex-column me-3">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-white opacity-75">Listes des rôles liés aux applications</li>
        </ul>
    </div>
    <!--begin::Actions-->
...
@section('content')
    <div class="card">
        ...
        <div class="card-body py-4" id="datapart">
            @include('application_role.datatable')
            
            @include('application_role.edit')
