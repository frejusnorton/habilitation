...
@section('page-title')
    <div class="page-title d-flex flex-column me-3">
        ...
        <h1 class="d-flex text-white fw-bolder my-1 fs-3">Gestion des menus</h1>
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-white opacity-75">Menus</li>
        </ul>
    </div>
    <!--begin::Actions-->
    <div class="d-flex align-items-center py-3 py-md-1">
        ...
        <a href="#" class="btn btn-primary btn-sm " data-bs-toggle="modal" data-bs-target="#kt_modal_add_menu"
            id="kt_toolbar_primary_button"> <i class="bi bi-plus fs-2x mx-1"></i> Nouveau menu</a>
