    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        <tbody class="text-gray-600 fw-semibold">
            @forelse ($directions as $direction)
                <tr>
                    <td>
                        <div class="badge badge-light fw-bold">{{ $direction->code  }}</div>
                    </td>
                    <td>
                        <div class="badge badge-light fw-bold">{{ $direction->libelle  }}</div>
                    </td>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="javascript:;" class="menu-link px-3 menu_edit_btn text-warning"
                                    data-bs-toggle="modal" id="editBtn" data-id="{{ $direction->id }}"
                                    data-code="{{ $direction->code }}" 
                                    data-libelle="{{ $direction->libelle }}" 
                                    data-statut="{{ $direction->statut }}" data-url="{{ route('direction.update', $direction->id) }}"
                            ...
                            <div class="menu-item px-3">
                                <a href="javascript:;" id="deleteBtn" class="menu-link px-3 text-danger"
                                    data-url="{{ route('direction.delete', $direction->id) }}"
