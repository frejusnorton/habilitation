...
@section('page-title')
    <div class="page-title d-flex flex-column me-3">
        <h1 class="d-flex text-white fw-bolder my-1 fs-3">Gestion des derogations</h1>
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-white opacity-75">Habilation par dérogation</li>
        </ul>
    </div>
...
@section('content')
    @include('derogation.create')
    @include('derogation.lists')
@endsection

@section('js')
    @include('derogation.js')
@endsection
