...
@section('page-title')
    <div class="page-title d-flex flex-column me-3">
        ...
        <h1 class="d-flex text-white fw-bolder my-1 fs-3">Gestion des roles et menu</h1>
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            ...
            <li class="breadcrumb-item text-white opacity-75">Roles et menu</li>
        </ul>
    </div>
...
@section('content')
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-user-table-filter="search" id="searchMenu"
                            class="form-control form-control-solid w-250px ps-13 filter" placeholder="Rechercher un menu" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_add_role_menu">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    <!--begin::Form-->
                                    <form id="kt_modal_export_menu_form" class="form" action="{{ route('app_role_menu_export') }}" method="POST">
                                        @csrf
    ...
    @include('role-menu.create')
    @include('role-menu.update')
@endsection

@section('js')

@include('role-menu.js')
