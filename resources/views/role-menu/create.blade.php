    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 my-7">
                <!--begin::Form-->
                <form id="addForm" class="form" action="{{ route('app_role_menu_new') }}" method="POST">
                    @csrf
                    <!--begin::Scroll-->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <select name="role" data-control="select2" data-placeholder="Selectionner le parent" data-hide-search="true" class="form-select form-select-solid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <select name="menu" data-control="select2" data-placeholder="Selectionner le parent" data-hide-search="true" class="form-select form-select-solid">
