...
<div class="table-responsive">
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        <tbody class="text-gray-600 fw-semibold">
            @forelse ($departements as $departement)
                <tr>
                    <td>
                        <div class="text-gray-800 text-hover-primary mb-1">{{ $departement->code }}</div>
                    </td>
                    <td>
                        <div class="text-gray-800 text-hover-primary mb-1">{{ $departement->libelle }}</div>
                    </td>
                    <td class="text-center">
                        {!! $departement->statut == 0
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="javascript:;" class="menu-link px-3 menu_edit_btn text-warning"
                                    data-bs-toggle="modal" id="editBtn" data-id="{{ $departement->id }}"
                                    data-code="{{ $departement->code }}" data-libelle="{{ $departement->libelle }}"
                                    data-statut="{{ $departement->statut }}"
                                    data-url="{{ route('departement.update', $departement->id) }}"
                            ...
                            <div class="menu-item px-3">
                                <a href="javascript:;" id="deleteBtn" class="menu-link px-3 text-danger"
                                    data-url="{{ route('departement.delete', $departement->id) }}"
    ...
    {{ $departements->links('pagination.custom') }}
</div>
